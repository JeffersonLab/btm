...
(
    ...
    CONSTRAINT EXP_HALL_SIGNATURE_AUD_CK1 CHECK (HALL IN ('A', 'B', 'C', 'D')),
    CONSTRAINT EXP_HALL_SIGNATURE_AUD_CK2 CHECK (EXTRACT(MINUTE FROM START_DAY_AND_HOUR) = 0 AND
                                                 EXTRACT(SECOND FROM START_DAY_AND_HOUR) = 0)
);
...
(
    ...
    CONSTRAINT EXP_HALL_SIGNATURE_CK1 CHECK (HALL IN ('A', 'B', 'C', 'D'))
);
...
(
    ...
    CONSTRAINT EXP_HALL_HOUR_REASON_TIME_AUD_FK1 FOREIGN KEY (REV) REFERENCES BTM_OWNER.REVISION_INFO (REV) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT EXP_HALL_REASON_AK1 UNIQUE (HALL, EXP_HALL_REASON_ID),
    CONSTRAINT EXP_HALL_REASON_AK2 UNIQUE (HALL, NAME),
...
(
    ...
    CONSTRAINT EXP_HALL_HOUR_REASON_TIME_AK1 UNIQUE (HALL, EXP_HALL_REASON_ID, EXP_HALL_HOUR_ID),
    CONSTRAINT EXP_HALL_HOUR_REASON_TIME_FK1 FOREIGN KEY (HALL, EXP_HALL_HOUR_ID) REFERENCES BTM_OWNER.EXP_HALL_HOUR (HALL, EXP_HALL_HOUR_ID) ON DELETE CASCADE,
    CONSTRAINT EXP_HALL_HOUR_REASON_TIME_FK2 FOREIGN KEY (HALL, EXP_HALL_REASON_ID) REFERENCES BTM_OWNER.EXP_HALL_REASON (HALL, EXP_HALL_REASON_ID) ON DELETE CASCADE,
