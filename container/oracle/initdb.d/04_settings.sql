...
ALTER SESSION SET CURRENT_SCHEMA = BTM_OWNER;

-- REQUIRED: Admin Config
insert into SETTING (KEY, VALUE, TYPE, DESCRIPTION, TAG, WEIGHT) values ('ADMIN_ROLE_NAME', 'btm-admin', 'STRING', 'App-specific Admin Role Name', 'AUTH', 1);
...
insert into SETTING (KEY, VALUE, TYPE, DESCRIPTION, TAG, WEIGHT) values ('NOTIFICATION_LINK_URL', 'https://github.com/JeffersonLab/btm', 'STRING', 'Notification link URL', 'NOTIFICATION', 4);
...
insert into SETTING (KEY, VALUE, TYPE, DESCRIPTION, TAG, WEIGHT) values ('HELP_DOC_CSV', 'https://github.com/JeffersonLab/btm|Home', 'CSV', 'CSV of documentation items where each item is a URL and a Label separated with the pipe symbol', 'HELP', 3);
