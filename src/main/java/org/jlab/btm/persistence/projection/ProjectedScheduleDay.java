...
public class ProjectedScheduleDay extends ScheduleDay {
    ...
    public ProjectedScheduleDay(Date dayMonthYear, String accProgram, Number kiloVoltsPerPass,
                                Number minHallCount, String hallANote, String hallBNote, String hallCNote,
                                String hallDNote, String note,
                                Number hallAProgramId, Number hallANanoAmps, Number hallAKiloVolts,
                                Number hallAPasses, Number hallAPriority, Character hallAPolarized,
                                Number hallBProgramId, Number hallBNanoAmps, Number hallBKiloVolts,
                                Number hallBPasses, Number hallBPriority, Character hallBPolarized,
                                Number hallCProgramId, Number hallCNanoAmps, Number hallCKiloVolts,
                                Number hallCPasses, Number hallCPriority, Character hallCPolarized,
                                Number hallDProgramId, Number hallDNanoAmps, Number hallDKiloVolts,
                                Number hallDPasses, Number hallDPriority, Character hallDPolarized) {
