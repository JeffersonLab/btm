...
public class ExpTimesheetStatus {
  ...
  /**
   * Since the CC previous hour is tied to another timesheet you can't just look to see if current
   * timesheet signature exists.
   */
  public boolean isTimesheetComplete() {
    return signatureComplete
        && shiftInfoComplete
        && reasonsNotReadyComplete
        && availabilityComplete
        && previousLastHourComplete;
  }
}
