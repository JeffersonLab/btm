...
public class MultiplicitySummaryTotals {
    ...
    public MultiplicitySummaryTotals(Number fourUpSeconds, Number threeUpSeconds, Number twoUpSeconds, Number oneUpSeconds, Number anyUpSeconds,
                                     Number allUpSeconds, Number downHardSeconds) {
