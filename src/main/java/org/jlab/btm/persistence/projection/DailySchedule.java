...
public class DailySchedule {
    ...
    public DailySchedule(Date day, String accProgram, Number kiloVoltsPerPass, String note,
                         Number hallANanoAmps, Number hallAKiloVolts, Number hallAPurposeId,
                         Number hallAPriority, Number hallAPasses, Character hallAPolarized,
                         Number hallBNanoAmps, Number hallBKiloVolts, Number hallBPurposeId,
                         Number hallBPriority, Number hallBPasses, Character hallBPolarized,
                         Number hallCNanoAmps, Number hallCKiloVolts, Number hallCPurposeId,
                         Number hallCPriority, Number hallCPasses, Character hallCPolarized,
                         Number hallDNanoAmps, Number hallDKiloVolts, Number hallDPurposeId,
                         Number hallDPriority, Number hallDPasses, Character hallDPolarized) {
        this.day = day;
