...
@Table(
    name = "EXP_SHIFT",
    schema = "BTM_OWNER",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"HALL", "START_DAY_AND_HOUR"})})
@NamedQueries({
  @NamedQuery(
      name = "ExpShift.findByExpShiftId",
      query = "SELECT e FROM ExpShift e WHERE e.expShiftId = :expShiftId"),
  @NamedQuery(
      name = "ExpShift.findByHallAndStartDayAndHour",
      query =
          "SELECT e FROM ExpShift e WHERE e.expProgram.hall = :hall AND e.startDayAndHour = :startDayAndHour")
})
public class ExpShift implements Serializable {
  ...
  public boolean equals(Object object) {
    ...
    return (this.expShiftId != null || other.expShiftId == null)
        && (this.expShiftId == null || this.expShiftId.equals(other.expShiftId));
  }
