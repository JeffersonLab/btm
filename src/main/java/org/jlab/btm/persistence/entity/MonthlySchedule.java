...
public class MonthlySchedule implements Serializable {
    ...
    private final static Logger LOGGER
            = Logger.getLogger(MonthlySchedule.class.getName());
    ...
    public boolean equals(Object object) {
        ...
        return (this.monthlyScheduleId != null || other.monthlyScheduleId == null) &&
                (this.monthlyScheduleId == null || this.monthlyScheduleId.equals(other.monthlyScheduleId));
    }
    ...
    public ScheduleDay getScheduleDay(Date day) {
        ...
        if(scheduleDayList != null) {
            for (ScheduleDay s : scheduleDayList) {
                // Don't use equals() method since java.util.Date and java.sql.Date and java.sql.Timestamp break this
