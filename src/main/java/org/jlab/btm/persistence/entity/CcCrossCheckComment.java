...
public class CcCrossCheckComment implements Serializable {
  ...
  @Id
  @SequenceGenerator(
      name = "OpCrossCheckCommentId",
      sequenceName = "CC_CROSS_CHECK_COMMENT_ID",
      allocationSize = 1)
  ...
  public boolean equals(Object object) {
    ...
    return (this.opCheckCommentId != null || other.opCheckCommentId == null)
        && (this.opCheckCommentId == null || this.opCheckCommentId.equals(other.opCheckCommentId));
  }

  @Override
  public String toString() {
    return "org.jlab.webapp.persistence.entity.OpCrossCheckComment[ opCheckCommentId="
        + opCheckCommentId
        + " ]";
  }
