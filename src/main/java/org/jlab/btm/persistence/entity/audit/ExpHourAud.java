...
public class ExpHourAud implements Serializable {
    ...
    @EmbeddedId
    protected ExpHourAudPK expHourAudPK;
    ...
    public boolean equals(Object object) {
        ...
        return (this.expHourAudPK != null || other.expHourAudPK == null) && (this.expHourAudPK == null || this.expHourAudPK.equals(other.expHourAudPK));
    }
}
