...
@NamedQueries({
  @NamedQuery(
      name = "ExpProgram.findByExpProgramId",
      query = "SELECT e FROM ExpProgram e WHERE e.expProgramId = :expProgramId"),
  @NamedQuery(
      name = "ExpProgram.findByHallAndName",
      query = "SELECT e FROM ExpProgram e WHERE e.hall = :hall AND e.name = :name"),
  @NamedQuery(
      name = "ExpProgram.findByHallAndActive",
      query = "SELECT e FROM ExpProgram e WHERE e.hall = :hall AND e.active = :active"),
  @NamedQuery(
      name = "ExpProgram.findByHallAndExperiment",
      query = "SELECT e FROM ExpProgram e WHERE e.hall = :hall AND e.experiment = :experiment")
})
public class ExpProgram implements Comparable<ExpProgram>, Serializable {
  ...
  public ExpProgram(
      BigInteger expProgramId, Hall hall, String name, boolean active, boolean experiment) {
    this.expProgramId = expProgramId;
    this.hall = hall;
    this.name = name;
    this.active = active;
  ...
  public boolean equals(Object object) {
    ...
    return (this.expProgramId != null || other.expProgramId == null)
        && (this.expProgramId == null || this.expProgramId.equals(other.expProgramId));
  }
