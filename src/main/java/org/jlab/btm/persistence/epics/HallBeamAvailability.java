...
public class HallBeamAvailability {
  ...
  public boolean isValidValue() {
    if (time == null || up == null || tune == null || bnr == null || down == null || off == null) {
      return false;
    }
   ...
   */
  public List<CcHallHour> getOpHallHours() throws CALoadException {
    List<CcHallHour> hours = new ArrayList<>();
    ...
    for (int i = 0; i < time.length; i++) {
      CcHallHour hour = new CcHallHour();
