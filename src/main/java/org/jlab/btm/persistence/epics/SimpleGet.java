 ...
 * <p>
 * This class wraps around the EPICS CAJ API and provides a slightly higher
 * level API for querying for EPICS data.
 *
 * @author ryans
 */
public class SimpleGet {
    ...
    /**
     * Wait for a connection to be created before returning and use the
     * specified timeout.
     *
     ...
     */
    public static void waitForConnection(SimpleConnectionListener conListener, int timeout) throws InterruptedException, TimeoutException {
    ...
    /**
     * A convenience method which waits for a connection to be created before
     * returning and uses a default timeout.
     *
     * @param conListener the connection listener.
     * @throws InterruptedException if the waiting thread is interrupted before
     *                              it is notified.
     * @throws TimeoutException     if the waiting has exceeded the timeout period.
     */
    public static void waitForConnection(SimpleConnectionListener conListener) throws InterruptedException, TimeoutException {
        waitForConnection(conListener, DEFAULT_TIMEOUT_MILLI);
    }

    /**
     * Wait for data to be transfered before returning and use the specified
     * timeout.
     *
     ...
     */
    public static void waitForData(SimpleGetListener getListener, int timeout) throws InterruptedException, TimeoutException, CAException {
    ...
    /**
     * A convenience method which waits for data to be transfered before
     * returning and uses the default timeout.
     *
     * @param getListener the get listener.
     * @throws InterruptedException if the waiting thread is interrupted before
     *                              it is notified.
     ...
     * @throws CAException          if a problem occurs transferring the EPICS data.
     */
    public static void waitForData(SimpleGetListener getListener) throws InterruptedException, TimeoutException, CAException {
        waitForData(getListener, DEFAULT_TIMEOUT_MILLI);
    }

    /**
     * Perform a CA Get on a single channel performed asynchronously
     * internally and using the specified timeout.
     *
     ...
     * @throws CAException          if a problem occurs transferring the EPICS data.
     */
    public static DBR doAsyncGet(Context context, String channelName, int timeout) throws InterruptedException, TimeoutException, CAException {
    ...
    /**
     * A convenience method which is performed a CA Get on a single channel, is
     * performed asynchronously internally, and uses the default timeout.
     *
     * @param context     the context.
     * @param channelName the channel name.
     * @return the EPICS record.
     ...
     * @throws CAException          if a problem occurs transferring the EPICS data.
     */
    public static DBR doAsyncGet(Context context, String channelName) throws InterruptedException, TimeoutException, CAException {
        return doAsyncGet(context, channelName, DEFAULT_TIMEOUT_MILLI);
    }

    /**
     * Perform a CA Get on multiple channels performed asynchronously
     * internally and using the specified timeout.
     *
     * @param context      the context.
     ...
     * @throws CAException          if a problem occurs transferring the EPICS data.
     */
    public static List<DBR> doAsyncGet(Context context, List<String> channelNames, int timeout) throws InterruptedException, TimeoutException, CAException {
    ...
    /**
     * A convenience method to perform a CA Get on multiple channels performed
     * asynchronously internally and using the default timeout.
     *
     * @param context      the context.
     * @param channelNames the channel names.
     * @return the EPICS records.
     ...
     * @throws CAException          if a problem occurs transferring the EPICS data.
     */
    public static List<DBR> doAsyncGet(Context context, List<String> channelNames) throws InterruptedException, TimeoutException, CAException {
        return doAsyncGet(context, channelNames, DEFAULT_TIMEOUT_MILLI);
    }

    /**
     * Perform a CA Get on a single channel performed synchronously
     * internally and using the specified timeout.
     *
     * @param context     the context.
     * @param channelName the channel name.
     ...
     * @throws CAException          if a problem occurs transferring the EPICS data.
     */
    public static DBR doSyncGet(Context context, String channelName, int timeout) throws InterruptedException, TimeoutException, CAException {
        Channel channel = null;
     ...
     * @throws CAException          if a problem occurs transferring the EPICS data.
     */
    public static DBR doSyncGet(Context context, String channelName) throws InterruptedException, TimeoutException, CAException {
        return doSyncGet(context, channelName, DEFAULT_TIMEOUT_MILLI);
    }

    /**
     * A convenience method to get the data array out of the EPICS record as
     * type double.
     *
