...
public class HourUtil {
     ...
     * <p>
     * The EPICS window is currently the previous week as of the present.
     *
    ...
    public static <T extends HourEntity> List<T> subset(Date startDayAndHour, Date endDayAndHour,
                                                        List<T> hours) {
        ...
        DateIterator iterator = new DateIterator(startDayAndHour, endDayAndHour,
    ...
    public static <T extends HourEntity> List<T> fillMissingHoursAndSetSource(
            Map<Date, T> dbHourMap, Map<Date, T> epicsHourMap,
            Date start, Date end, Class<T> clazz) {
