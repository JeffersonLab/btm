 ...
 */
@WebServlet(
    name = "SignExpTimesheet",
    urlPatterns = {"/ajax/sign-exp-timesheet"})
public class SignExpTimesheet extends HttpServlet {

  private static final Logger logger = Logger.getLogger(SignExpTimesheet.class.getName());
