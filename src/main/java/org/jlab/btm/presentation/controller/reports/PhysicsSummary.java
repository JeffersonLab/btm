...
@WebServlet(
    name = "PhysicsSummary",
    urlPatterns = {"/reports/physics-summary"})
public class PhysicsSummary extends HttpServlet {

  @EJB CcMultiplicityHourService multiplicityService;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (start != null && end != null) {
      ...
      selectionMessage =
          (selectionMessage + " " + TimeUtil.formatSmartRangeSeparateTime(start, end)).trim();
    }
    ...
    request
        .getRequestDispatcher("/WEB-INF/views/reports/physics-summary.jsp")
