...
public class ActivityAudit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Paginator paginator = new Paginator(totalRecords.intValue(), params.getOffset(), params.getMaxPerPage());
    ...
    public String getSelectionMessage(ActivityAuditParams params, Paginator paginator) {
        ...
        if (params.getModifiedStart() != null && params.getModifiedEnd() != null) {
            filters.add(TimeUtil.formatSmartRangeSeparateTime(params.getModifiedStart(), params.getModifiedEnd()));
        ...
        if(params.getTimesheetDate() != null) {
            filters.add("Timesheet Date \"" + TimeUtil.formatSmartSingleTime(params.getTimesheetDate()) + "\"");
        }
