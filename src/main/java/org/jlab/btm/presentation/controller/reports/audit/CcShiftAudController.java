 ...
 */
@WebServlet(
    name = "CcShiftAudController",
    urlPatterns = {"/reports/activity-audit/cc-shift"})
public class CcShiftAudController extends HttpServlet {

  @EJB CcShiftAudService audService;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    request
        .getRequestDispatcher("/WEB-INF/views/reports/activity-audit/cc-shift.jsp")
