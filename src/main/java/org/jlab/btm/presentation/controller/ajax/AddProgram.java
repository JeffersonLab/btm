...
@WebServlet(
    name = "AddProgram",
    urlPatterns = {"/ajax/add-program"})
public class AddProgram extends HttpServlet {

  private static final Logger logger = Logger.getLogger(AddProgram.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      logger.log(Level.WARNING, "Unable to add program due to access exception", e);
