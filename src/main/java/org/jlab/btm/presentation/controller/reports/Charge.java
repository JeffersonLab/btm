 ...
 * @author ryans
 */
@WebServlet(name = "Charge", urlPatterns = {"/reports/charge"})
public class Charge extends HttpServlet {

    private final static Logger LOGGER
            = Logger.getLogger(Charge.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/reports/charge.jsp").forward(request,
                response);
    }
