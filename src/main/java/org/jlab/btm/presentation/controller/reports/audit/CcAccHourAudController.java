 ...
 * @author ryans
 */
@WebServlet(name = "CcAccHourAudController", urlPatterns = {"/reports/activity-audit/cc-acc-hour"})
public class CcAccHourAudController extends HttpServlet {

    @EJB
    CcAccHourAudService audService;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/reports/activity-audit/cc-acc-hour.jsp").forward(request, response);
    }
}
