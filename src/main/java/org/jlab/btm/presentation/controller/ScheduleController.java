...
public class ScheduleController extends HttpServlet {
    ...
    if (schedule != null) {
      ...
      if ("calendar".equals(view)) {
        ...
        for (ScheduleDay day : dayList) {
          MonthDay md =
              MonthDay.from(day.getDayMonthYear().toInstant().atZone(ZoneId.systemDefault()));
  ...
  private String getPreviousUrl(HttpServletRequest request, Date date) {
    ...
    String url =
        request.getContextPath() + "/schedule/" + dateFormat.format(previousMonth).toLowerCase();
  ...
  private String getNextUrl(HttpServletRequest request, Date date) {
    ...
    String url =
        request.getContextPath() + "/schedule/" + dateFormat.format(nextMonth).toLowerCase();
