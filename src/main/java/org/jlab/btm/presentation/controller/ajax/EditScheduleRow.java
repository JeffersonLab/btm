 ...
 * @author ryans
 */
@WebServlet(name = "EditScheduleRow", urlPatterns = {"/ajax/edit-schedule-row"})
public class EditScheduleRow extends HttpServlet {

    private static final Logger logger = Logger.getLogger(
            EditScheduleRow.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer kiloVoltsPerPass = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "kiloVoltsPerPass");
            Integer minHallCount = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "minHallCount");
            ...
            Integer hallAKiloVolts = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallAKiloVolts");
            Integer hallBKiloVolts = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallBKiloVolts");
            Integer hallCKiloVolts = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallCKiloVolts");
            Integer hallDKiloVolts = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallDKiloVolts");
            Integer hallANanoAmps = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallANanoAmps");
            Integer hallBNanoAmps = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallBNanoAmps");
            Integer hallCNanoAmps = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallCNanoAmps");
            Integer hallDNanoAmps = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallDNanoAmps");
            boolean hallAPolarized = ParamUtil.convertAndValidateYNBoolean(request,
                    "hallAPolarized");
            boolean hallBPolarized = ParamUtil.convertAndValidateYNBoolean(request,
                    "hallBPolarized");
            boolean hallCPolarized = ParamUtil.convertAndValidateYNBoolean(request,
                    "hallCPolarized");
            boolean hallDPolarized = ParamUtil.convertAndValidateYNBoolean(request,
                    "hallDPolarized");
            ...
            Integer hallAPriority = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallAPriority");
            Integer hallBPriority = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallBPriority");
            Integer hallCPriority = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallCPriority");
            Integer hallDPriority = ParamUtil.convertAndValidateNonNegativeInteger(request,
                    "hallDPriority");
            ...
            monthlyScheduleService.editRow(date, scheduleId, accProgram, kiloVoltsPerPass, minHallCount,
                    hallAProgramId, hallBProgramId,
                    ...
                    hallCPriority, hallDPriority, hallANotes, hallBNotes, hallCNotes, hallDNotes, notes, count);
