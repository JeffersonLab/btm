 ...
 * @author ryans
 */
@WebServlet(name = "Upload", urlPatterns = {"/schedule/upload"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            LOGGER.log(Level.WARNING,
                    "Unable to upload due to access exception", e);
        ...
        if (errorReason == null) {
            ...
            for (MonthlySchedule schedule : resultList) {
                xml = xml + "<span class=\"schedule\">"
                        + "<span class=\"date\">" + formatter.format(schedule.getStartDay()) + "</span>"
                        + "<span class=\"version\">" + schedule.getVersion() + "</span></schedule>";
            }
