...
@WebServlet(
    name = "EditMultiHours",
    urlPatterns = {"/ajax/edit-multi-hours"})
public class EditMultiHours extends HttpServlet {

  private static final Logger logger = Logger.getLogger(EditMultiHours.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      Short[] fourUpArray = ParamConverter.convertShortArray(request, "fourUp[]", (short) 0);
      Short[] threeUpArray = ParamConverter.convertShortArray(request, "threeUp[]", (short) 0);
      Short[] twoUpArray = ParamConverter.convertShortArray(request, "twoUp[]", (short) 0);
      Short[] oneUpArray = ParamConverter.convertShortArray(request, "oneUp[]", (short) 0);
      Short[] anyUpArray = ParamConverter.convertShortArray(request, "anyUp[]", (short) 0);
      Short[] allUpArray = ParamConverter.convertShortArray(request, "allUp[]", (short) 0);
      Short[] downHardArray = ParamConverter.convertShortArray(request, "downHard[]", (short) 0);

      multiHourService.editMultiHours(
          hourArray,
          fourUpArray,
          threeUpArray,
          twoUpArray,
      ...
      logger.log(Level.WARNING, "Unable to edit multiplicity hours due to access exception", e);
      ...
      if (rootCause instanceof SQLException) {
        ...
        logger.log(Level.SEVERE, "Unable to edit multiplicity hours", e);
        ...
        logger.log(
            Level.FINEST, "Unable to edit multiplicity hours due to constraint violoation", e);
