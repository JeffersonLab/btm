 ...
 * @author ryans
 */
@WebServlet(name = "EditExpHours", urlPatterns = {"/ajax/edit-exp-hours"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Date[] hourArray = BtmParamConverter.convertDayHourArray(request,
                    "hour[]");
            Short[] abuArray = ParamConverter.convertShortArray(request,
                    "abu[]", (short) 0);
            Short[] banuArray = ParamConverter.convertShortArray(request,
                    "banu[]", (short) 0);
            Short[] bnaArray = ParamConverter.convertShortArray(request,
                    "bna[]", (short) 0);
            Short[] accArray = ParamConverter.convertShortArray(request,
                    "acc[]", (short) 0);
            Short[] offArray = ParamConverter.convertShortArray(request,
                    "off[]", (short) 0);
            Short[] erArray = ParamConverter.convertShortArray(request,
                    "er[]", (short) 0);
            Short[] pccArray = ParamConverter.convertShortArray(request,
                    "pcc[]", (short) 0);
            Short[] uedArray = ParamConverter.convertShortArray(request,
                    "ued[]", (short) 0);
            String[] commentsArray = request.getParameterValues("comments[]");

            expHourService.editExpHours(hall, hourArray, abuArray, banuArray, bnaArray,
                    accArray, offArray, erArray, pccArray, uedArray, commentsArray);
            ...
            logger.log(Level.WARNING,
                    "Unable to edit availability hours due to access exception", e);
            errorReason = "Access Denied";
        } catch (UserFriendlyException e) {
            logger.log(Level.INFO,
                    "Unable to edit availability hours: {0}",
                    e.getMessage());
            ...
            if (rootCause instanceof SQLException) {
                ...
                logger.log(Level.SEVERE,
                        "Unable to edit availability hours", e);
                ...
                for (ConstraintViolation<?> violation : violations) {
                    ...
                    if (bean instanceof OpAccHour) {
                        OpAccHour hour = (OpAccHour) bean;
                ...
                logger.log(Level.FINEST,
                        "Unable to edit availability hours due to constraint violation",
                        e);
