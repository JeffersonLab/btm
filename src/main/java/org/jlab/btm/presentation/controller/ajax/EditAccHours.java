 ...
 * @author ryans
 */
@WebServlet(name = "EditAccHours", urlPatterns = {"/ajax/edit-acc-hours"})
public class EditAccHours extends HttpServlet {

    private static final Logger logger = Logger.getLogger(
            EditAccHours.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Short[] upArray = ParamConverter.convertShortArray(request,
                    "up[]", (short) 0);
            Short[] sadArray = ParamConverter.convertShortArray(request,
                    "sad[]", (short) 0);
            Short[] downArray = ParamConverter.convertShortArray(request,
                    "down[]", (short) 0);
            Short[] studiesArray = ParamConverter.convertShortArray(request,
                    "studies[]", (short) 0);
            Short[] restoreArray = ParamConverter.convertShortArray(request,
                    "restore[]", (short) 0);
            Short[] accArray = ParamConverter.convertShortArray(request,
                    "acc[]", (short) 0);

            accHourService.editAccHours(hourArray, upArray, sadArray, downArray,
                    studiesArray, restoreArray, accArray);
            ...
            logger.log(Level.WARNING,
                    "Unable to edit accelerator availability hours due to access exception", e);
            errorReason = "Access Denied";
        } catch (UserFriendlyException e) {
            logger.log(Level.INFO,
                    "Unable to edit accelerator availability hours: {0}",
                    e.getMessage());
            ...
            if (rootCause instanceof SQLException) {
                ...
                logger.log(Level.SEVERE,
                        "Unable to edit accelerator availability hours", e);
