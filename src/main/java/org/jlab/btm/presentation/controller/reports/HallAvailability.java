...
public class HallAvailability extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    request
        .getRequestDispatcher("/WEB-INF/views/reports/hall-availability.jsp")
  ...
  private String getCurrentUrl(HttpServletRequest request, Date start, Date end, String chart) {
    ...
    return request.getContextPath()
        + "/reports/hall-availability?start="
        ...
        + "&availability-chart="
        + URLEncoder.encode(chart, StandardCharsets.UTF_8);
  }
}
