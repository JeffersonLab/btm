 ...
 * @author ryans
 */
@WebServlet(name = "EditCrossCheckComment", urlPatterns = {"/ajax/edit-cross-check-comment"})
public class EditCrossCheckComment extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(EditCrossCheckComment.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            crossCheckCommentService.editCrewChiefRemark(startDayAndHour, comments);
