...
/**
 * A Wall Calendar is a monthly calendar formatted in a table layout with the first day of the week
 * starting Sunday and each day contains zero or more ordered notes. Days from previous and next
 * months necessary to create full weeks are included.
 *
