...
public final class BtmParamConverter {
    ...
    public static Date convertJLabDateTime(HttpServletRequest request, String name) throws ParseException {
    ...
    public static Date convertDayMonthAndYear(HttpServletRequest request, String name) throws
            ParseException {
        final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MMM-yyyy");
    ...
    public static Date convertMonthAndYear2(HttpServletRequest request, String name) throws
            ParseException {
        final DateTimeFormatter formatter = new DateTimeFormatterBuilder().parseCaseInsensitive().appendPattern("MMMM yyyy").toFormatter();
    ...
    public static Date convertISO8601Date(HttpServletRequest request, String name, Date defaultValue) throws
            ParseException {
    ...
    public static Date convertISO8601Date(String valueStr) throws
            ParseException {
        final DateTimeFormatter formatter = new DateTimeFormatterBuilder().parseCaseInsensitive().appendPattern("yyyy-MM-dd").toFormatter();
    ...
    public static Date convertDayAndHour(HttpServletRequest request, String name) throws
            ParseException {
    ...
    public static Date[] convertDayHourArray(HttpServletRequest request, String name) throws
            ParseException {
        String[] valueStrArray = request.getParameterValues(name);
        Date[] valueArray = null;
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd-HH-z"); // DateTimeFormatter does not handle EST/EDT the same so we keep old code
    ...
    public static Shift convertShift(HttpServletRequest request, String name,
                                     Shift defaultValue) {
        String valueStr = request.getParameter(name);
        Shift value;
    ...
    public static DurationUnits convertDurationUnits(HttpServletRequest request, String name,
                                                     DurationUnits defaultValue) {
        String valueStr = request.getParameter(name);
        DurationUnits value;
